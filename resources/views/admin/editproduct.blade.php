...
{{--     
    ...
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="product_name" name="product_name" value="{{$product->name}}">
  </div>

  <div class="col-4">
    <label for="product_price" class="mr-sm-2">Price:</label>
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="product_price" name="product_price" value="{{$product->price}}">
  </div>

  <div class="col-4">
    <label for="product_quantity" class="mr-sm-2">Quantity:</label>
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="product_quantity" name="product_quantity" value="{{$product->quantity}}">
  </div>


  <div class="col-4">
    <label for="product_category" class="mr-sm-2">Category:</label>
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="product_category" name="product_category" value="{{$product->category}}">
  </div>

  <div class="col-4">
    <label for="product_image" class="mr-sm-2">Image:</label>
    <input type="file" class="form-control mb-2 mr-sm-2" placeholder="" id="product_image" name="product_image" value="{{asset('/storage/images/products/'.$product->image)}}">
  </div>

  <div class="col-6">
    <label for="product_description" class="mr-sm-2">Description</label>
    <textarea name="product_description" class="form-control mb-2 mr-sm-2" id="" rows="5" cols="40" name="product_description" value="{{$product->description}}"></textarea>
  </div>
