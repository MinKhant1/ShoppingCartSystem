        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\DeliveryMethodController@savedeliverymethod', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  {{Form::label('', 'Delivery name', ['for' => 'exampleInputEmail1' ])}}
                  {{Form::text('name', '',  ['placeholder' => 'Enter Delivery name','class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                </div>
