        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\PaymentMethodController@savepaymentmethod', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  {{Form::label('', 'Payment name', ['for' => 'exampleInputEmail1' ])}}
                  {{Form::text('name', '',  ['placeholder' => 'Enter Payment Method name','class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                </div>
