        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\DeliveryMethodController@updatedeliverymethod', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  {{Form::hidden('id', $delivery_method->id)}}
    <div class="col-4">
    <label for="name" class="mr-sm-2">Product Name:</label>
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="name" name="name" value="{{$delivery_method->name}}">
  </div>
                </div>
